...
const DEFAULT_BOTS_FOLDER = 'riskmanagers.site';
...
export const DOMAIN_CONFIG: Record<string, DomainConfig> = {
    ...
    ...createHostedDomainEntries({
        ...
        appId: '133717',
        redirectUri: 'https://ramzfxy.vercel.app/',
        includeLegacyAppIdInOAuth: true,
        features: {
            botIdeas: false,
            autoTrades: true,
...
export const getDomainConfig = (): DomainConfig => {
    ...
    return {
        clientId: process.env.CLIENT_ID || '33sEw8wCxqfzfQqOlk7O6',
        appId: process.env.APP_ID || '133717',
